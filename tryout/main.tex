...
Insbesondere tabellarische Darstellungen und Übersichten liefern dem LLM häufig zu wenig expliziten Kontext, um die enthaltenen Informationen adäquat zu erfassen und in Beziehung zu setzen \parencite{sui_table_2024}. Dieses Problem tritt im IT-Betrieb besonders deutlich auf, da technische Dokumentationen stark von strukturierten Darstellungen wie Tabellen zu IP-Adressräumen, Portfreigaben oder Systemumgebungen geprägt sind. Für domänenspezifische, semistrukturierte IT-Administrationsdaten, wie sie typischerweise in internen Wikis vorliegen, existiert bislang nur begrenzte Forschung im Kontext von RAG-Systemen.
